                ...
                <aside className={styles.searchWrap}>
                    <div className={styles.search}>
                        <label htmlFor="search">
                            <input placeholder='ادخل رقم البوليصة' type="text" id="search" value={billNo} onChange={e => setBillNo(e.target.value)}/>
                        ...
                        :
                            <>
                                {Object.keys(billData).length > 0?
                                    <div style={{width:'100%'}}>
                                        <MaltransData data={billData} tokenKey={token} logout={logout} username={username}/>
                                    </div>
                                :
                                    <></>
                                }
